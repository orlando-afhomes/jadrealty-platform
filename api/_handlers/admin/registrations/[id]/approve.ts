...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const buildMemberRow = (referralCode: string) => ({
    ...
    province_code: (row.province_code as string | undefined) ?? null,
    province_name: (row.province_name as string | undefined) ?? null,
    city_code: (row.city_code as string | undefined) ?? null,
    city_name: (row.city_name as string | undefined) ?? null,
    barangay_code: (row.barangay_code as string | undefined) ?? null,
    barangay_name: (row.barangay_name as string | undefined) ?? null,
    region_name: (row.region_name as string | undefined) ?? null,
